...
public class UsuariosVO {
    ...
    public UsuariosVO(int id, String n_user, String nombre, int edad, String apellidos, String direccion, String correo, String pass, String tipo_sangre, String alcohol, String altura, String peso, String psicologica, String antecendentes, String tratamientos, String alergias, String dolores) {
        this.id = id;
        this.n_user = n_user;
        this.nombre = nombre;
        this.edad = edad;
